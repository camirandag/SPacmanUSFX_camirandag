...
TextureManager::TextureManager()
{
	...
	monedaClasicaTexture = new Texture();
	monedaClasicaTexture->loadFromImage(pathMonedaClasica);
	addTexture("monedaClasica", monedaClasicaTexture);

	monedaGalacticoTexture = new Texture();
	monedaGalacticoTexture->loadFromImage(pathMonedaGalactico);
	addTexture("monedaGalactico", monedaGalacticoTexture);
